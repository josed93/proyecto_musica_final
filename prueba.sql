...
--
-- Servidor: localhost
-- Tiempo de generación: 27-03-2016 a las 17:57:07
...
INSERT INTO `AUTOR` (`COD_AUTOR`, `NOMBRE_A`, `FECHA_NAC`) VALUES
...
INSERT INTO `CANCION` (`COD_CANCION`, `TITULO_C`, `DURACION`, `COD_DISCO`) VALUES
(1, 'Blackstar', '9:57', 1),
...
(27, 'Uno X uno', '3:49', 3),
(28, 'PequeÃ±a sonrisa sonora', '4:04', 3),
(29, 'Yo quiero vivir', '4:03', 3),
(30, 'Amor planetario', '4:10', 3),
(31, 'La voz de dentro', '4:07', 3),
(32, 'No tengo prisa', '3:18', 3),
(33, 'Y ahora lo sÃ©', '3:48', 3),
(34, 'PÃ¡jaro sin vuelo', '5:01', 3),
(35, 'Libre', '4:08', 3),
(36, 'Quiero', '3:40', 4),
(37, 'SÃƒÂ­gueme el Juego', '3:34', 4),
(38, 'Cenizas', '4:05', 4),
...
INSERT INTO `CESTA` (`COD_USU`, `COD_DISCO`, `CANTIDAD`, `PRECIO_UNITARIO`) VALUES
(14, 3, 1, 0.00);
...
INSERT INTO `DISCO` (`COD_DISCO`, `TITULO`, `GENERO`, `FECHA`, `CARATULA`, `CANTIDAD`, `PRECIO`, `COD_DISCOGRA`, `COD_AUTOR`) VALUES
...
INSERT INTO `DISCOGRAFICA` (`COD_DISCOGRA`, `NOMBRE`, `FUNDACION`, `PAGINA_WEB`) VALUES
...
INSERT INTO `LINEA_PEDIDO` (`COD_LINEA`, `COD_PEDIDO`, `COD_DISCO`, `CANTIDAD`) VALUES
(1, 1, 2, 2),
(2, 1, 4, 2),
(3, 2, 4, 1),
(4, 3, 5, 1),
...
INSERT INTO `USUARIO` (`COD_USU`, `USERNAME`, `PASSWORD`, `ROL`, `ESTADO`, `DNI`, `NOMBRE`, `APELLIDOS`, `FECHA_NAC`, `DIRECCION`, `TLF`, `EMAIL`, `PROVINCIA`, `LOCALIDAD`, `PAIS`, `STYLE`) VALUES
(1, 'josed', '1c2c02d3a8a758f49ed17585ad5c5f54', 'admin', 'activo', '53930055T', 'Jose Daniel', 'de las Heras Diaz', '1993-03-08', 'Corral del Conde NÃ‚Âº6', 655599239, 'jose_d.93@hotmail.com', 'Sevilla', 'Gerena', 'EspaÃƒÂ±a', 0),
(8, 'carol', 'a9a0198010a6073db96434f6cc5f22a8', 'user', 'activo', '20503311F', 'Carolyne', 'Fernandez', '1996-03-11', 'Granada', 659845213, 'carolyne.nicolle@hotmail.com', 'Sevilla', 'Sevilla', 'Peru', 2),
(11, 'japon', '7cb51895c351c3b0e2afbbda27e873a2', 'user', 'activo', '77824418P', 'Juan Antonio', 'Japon de la Torre', '1991-02-03', 'C/ Clara de JesÃƒÂºs Montero NÃ‚Âº28 2Ã‚ÂºC 3', 634692434, 'juan.antonio.japon@gmail.com', 'Sevilla', 'Sevilla', 'EspaÃƒÂ±a', 0),
