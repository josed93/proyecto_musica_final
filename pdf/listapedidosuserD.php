...
$pdf->Cell(10, 25, 'LISTA DE PEDIDOS DE '.$_SESSION["user"], 0);
$pdf->Ln(23);
...
$pdf->SetFont('Arial', '', 8);
//CONSULTA
$usuarios = $connection->query("SELECT *,LP.CANTIDAD AS CANT FROM PEDIDO P,USUARIO U,LINEA_PEDIDO LP,DISCO D WHERE P.COD_USU=U.COD_USU AND P.COD_PEDIDO=LP.COD_PEDIDO AND LP.COD_DISCO=D.COD_DISCO AND U.USERNAME='".$_SESSION["user"]."' ORDER BY FECHA_PED ASC");
...
$pdf->SetFont('Arial', 'B', 8);
$filename='listapedidosuser'.$_SESSION["user"].'.pdf';
