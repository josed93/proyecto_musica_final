...
?>
    ...
    onchange="try{setCustomValidity('')}catch(e){}" /><br>
        ...
        <button type="submit" name="sub" style=" background-color: #DF0101;color:white;font-weight:bold;margin-top:2%" class="btn btn-muted col-sm-0 col-sm-offset-5"
          onMouseOver="this.style.cssText='background-color: #FF0000;color:#2E2E2E;font-weight:bold;margin-top:2%'" onMouseOut="this.style.cssText='background-color: #DF0101;color:white;font-weight:bold;margin-top:2%'"><span class="glyphicon glyphicon-floppy-saved"></span> CREAR CUENTA</button>
